 ...
 */
public class QuadratinMainDataGridItem {
    ...
    public QuadratinMainDataGridItem(int item_position_parent, int item_position, String item_category_title, Integer item_image) {
