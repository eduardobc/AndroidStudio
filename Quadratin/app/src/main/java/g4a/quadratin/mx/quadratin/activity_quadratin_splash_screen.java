...
public class activity_quadratin_splash_screen  extends ActionBarActivity {
    public static final int secconds = 4;
    ...
    public void quadratin_start_progressbar() {
        new CountDownTimer(milsecconds,1000) {
            ...
            public void onFinish() {
                Intent quadratin_activity_intro = new Intent(activity_quadratin_splash_screen.this,activity_quadratin_intro.class);
                startActivity(quadratin_activity_intro);
                finish();
            }
        }.start();
    }
